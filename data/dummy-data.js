...
export const MEALS = [
  ...
  new Meal(
    ...
    'pricey',
    'simple',
    'https://www.ekushey-tv.com/media/imgAll/2020June/109406878_2542-2007161303.jpg',
    45,
    [
      'কাঠাল একটি প্রাকৃতিক ফল',
      'বিভিন্ন রকম ফলের মধ্যে একটি যা বাংলাদেশের সবচেয়ে বেশি পাওয়া যায়।',
      'কাঠাল বাংলাদেশের জাতীয় ফল হিসেবে পরিচিত।',
    ...
    [
      "যেহেতু কাঠাল প্রাকৃতিক ফল, তাই এটা দিয় দিয়ে বিভিন্ন প্রকার খাদ্য প্রণালী তৈরি করা যায়।",
      "শ্রীলঙ্কা তে সবজি হিসেবে কাঠালের কারি তৈরি করা হয়।",
      "পশ্চিমবঙ্গে তৈরি করা হয় সবুজ কাঠালের সাথে আলুর কারি",
      "কাঠালের মাসালা (ভারত)",
      "নারিকেল তেলে কাঠালের ফ্রাই কেরালা, ভারত"
    ],
    false,
    false,
    false,
  ...
  new Meal(
    ...
    'pricey',
    'simple',
    'https://www.dailyinqilab.com/news_original/1627568483_6.jpg',
    45,
    [
      'পেয়ারা একটি প্রাকৃতিক ফল',
      'বিভিন্ন রকম ফলের মধ্যে একটি যা বাংলাদেশের সবচেয়ে বেশি পাওয়া যায়।',
      'পেয়ারা বাংলাদেশের প্রসিদ্ধ ফল হিসেবে পরিচিত।',
    ...
    [
      "প্রাকৃতিক ফল, তাই বিশেষ প্রস্তুত প্রণালী নেই।"
    ],
    false,
    false,
    false,
